    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden"> 
      ...
      >
        ...
        <div className='text-secondary'>
          NOTE: After a period of inactivity, the backend service may experience a bit of delay
          when processing requests. Please be patient while the request is fulfilled.
        </div>
